        ...
        <div className="space-y-8 sm:space-y-12">
          ...
          <div className="space-y-4 sm:space-y-6">
            <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black tracking-tight leading-tight">
              ...
              <span className="block text-slate-300 drop-shadow-2xl">Services</span>
            </h1>
          ...
          <div className="max-w-3xl mx-auto px-2">
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl text-slate-300 font-medium leading-relaxed">
              Elite engineering solutions that
              <span className="text-slate-200 font-bold"> actually work</span>
              <span className="block mt-2 text-base sm:text-lg text-slate-400">From concept to deployment, we handle everything with precision and expertise.</span>
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center pt-8 sm:pt-12">
            ...
            >
              <span className="flex items-center justify-center">
                View Portfolio
                <Rocket className="ml-2 sm:ml-3 w-4 h-4 sm:w-5 sm:h-5 group-hover:rotate-12 transition-transform duration-300" />
              </span>
            </Button>
          </div>
